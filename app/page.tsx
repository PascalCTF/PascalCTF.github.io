      ...
      <main className="flex-1 flex items-center justify-center min-h-[calc(100vh-4rem)]">
        <div className="text-center">
          <div className="mb-8">
            ...
            <h1 className="text-6xl font-bold text-gray-900 dark:text-white mb-4">PascalCTF</h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              PascalCTF is a Capture The Flag (CTF) competition organized by the team Blaisone.
            </p>
          </div>
        </div>
      </main>
      ...
      <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-500 dark:text-gray-400">© 2025 Blaisone CTF Team</p>
